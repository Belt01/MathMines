...
"")
        ...
        self.Answer_A.clicked.connect(lambda: verifyA(placar))
        self.Answer_B.clicked.connect(lambda: verifyB(placar))
        self.Answer_C.clicked.connect(lambda: verifyC(placar))
        self.Answer_D.clicked.connect(lambda: verifyD(placar))
        self.pushButton.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2)) 
        self.pushButton.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_2.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_2.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_3.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_3.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_4.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_4.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_5.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_5.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_6.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_6.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_7.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_7.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_8.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_8.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_9.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_9.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_10.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_10.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_11.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_11.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_12.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_12.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_13.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_13.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_14.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_14.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_15.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_15.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
        self.pushButton_16.clicked.connect(lambda: self.stackedWidget_initial.setCurrentWidget(self.page_2))
        self.pushButton_16.clicked.connect(lambda: self.label_2.setPixmap(QtGui.QPixmap(rngen())))
